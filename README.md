...
```
    ...
    ## Geometry type: POINT
    ## Dimension:     XY
    ## Bounding box:  xmin: -7.110488 ymin: 38.06269 xmax: 59.58653 ymax: 66.84904
    ## Geodetic CRS:  WGS 84
    ##   label               Data                   geometry
    ## 1     1    Kimori treeckoi   POINT (18.57076 63.9073)
    ## 2     2   Achamo torchicum  POINT (33.51637 54.00598)
    ## 3     3   Achamo torchicum POINT (0.6654467 48.03017)
    ## 4     4 Mizugorou mudkipus  POINT (39.90139 66.84904)
    ## 5     5    Kimori treeckoi POINT (-7.110488 38.06269)
    ## 6     6    Kimori treeckoi  POINT (59.58653 65.16419)
